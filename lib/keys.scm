...
(when (key-pressed "a")
	(shapeSchema triangolo triangolo triangolo)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
...
(when (key-pressed "s")
	(shapeSchema bigring bigring bigring)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
;	(set! prtclSys3Color (vector 1 1 0))
)
...
(when (key-pressed "f")
	(shapeSchema piramidiring piramidiring piramidiring)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
...
(when (key-pressed "g")
	(shapeSchema triangoliring triangoliring triangoliring)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
...
(when (key-pressed "h")
	(shapeSchema triangolo piramidiring triangoliring)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
;	(set! prtclSys3Color (vector .5 0 1))
)
...
(when (key-pressed "l")
	(shapeSchema triC piramidiring triangoliring)
;	(particlesReset prtclSys3)
;	(psys3VelReset)
...
(when (key-pressed "z")
	(shapeSchema kube bigring bigring)
;	(particlesReset prtclSys2)
;	(psys2VelReset)
...
(when (key-pressed "x")
	(shapeSchema triA triangoliring piramidiring)
;	(particlesReset prtclSys2)
;	(psys2VelReset)
...
(when (key-pressed "c")
	(shapeSchema hexA piramidiring triangoliring)
;	(particlesReset prtclSys2)
;	(psys2VelReset)
...
(when (key-pressed "v")
	(shapeSchema moleculeA piramidiring bigring)
;	(particlesReset prtclSys2)
;	(psys2VelReset)
...
(when (key-pressed "b")
	(shapeSchema nautilus triangoliring bigring)
;	(particlesReset prtclSys2)
;	(psys2VelReset)
...
(when (key-pressed "m")
	(shapeSchema subaddiction piramidiring triangoliring)
